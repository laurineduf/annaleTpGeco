...
public class QuestionAChoixExclusif implements QuestionAChoix {
    ...
    /**
     * enonce c'est l'enonce de la question.
     */
    private String enonce;
    /**
     * indiceBonneReponse l'indice de la bonne reponse.
     */
    private int indiceBonneReponse;

    /**
     * Une question à choix excusive est complètement
     * caractérisé par son énoncé et l'indice de sa bonne réponse.
     ...
     * @return 100 si l'indice du choix fourni est l'indice
     * de la bonne réponse, 0 autrement
     */
